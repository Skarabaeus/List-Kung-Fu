...
base_files = %w{application Controller jquery-rails jquery.ConfirmationDialog jquery.Dashboard jquery.hotkeys jquery.ListItemView jquery.ListView jquery.SerializeForm jquery.StatusBar json2 mustache jquery.layout-1.2.0 jquery.TagView jquery.UltimateSearch}.map { |js| File.join( src_dir, "#{js}.js" ) }
