...
theme_advanced_buttons3:"tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,cite,abbr,acronym|,advhr,|,print,|,fullscreen",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:false,init_instance_callback:ListKungFu.TinyMceInitAutoFocus,width:"100%"};jQuery.expr[":"].Contains=function(b,c,i){return jQuery(b).text().toLowerCase().indexOf(i[3].toLowerCase())>=0};
jQuery.expr[":"].HasExactValue=function(b,c,i){return jQuery.trim(jQuery(b).text().toLowerCase())===i[3].toLowerCase()};
...
{},300).focus()},destroy:function(){this.element.children().remove();$(document).unbind("keydown","c").unbind("keyup","f")},Filter:function(b){this.selectedText=b;this._Filter()}})})();
