...
this.listItemList.find(".row").first().effect("highlight",{},300,function(){$(this).show().focus()})},destroy:function(){this.element.children().remove();$(document).unbind("keydown","c").unbind("keyup","f")},Filter:function(b){this.selectedText=b;this._Filter()}})})();
