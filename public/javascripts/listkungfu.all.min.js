...
{},300).focus()},destroy:function(){this.element.children().remove();$(document).unbind("keydown","c").unbind("keyup","f")},Filter:function(b){this.selectedText=b;this._Filter()},FocusElement:function(b){switch(b){case "saveButton":$("#save-whenever").focus();$("#keepit").focus()}}})})();
