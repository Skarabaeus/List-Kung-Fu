...
_CreateToolbar:function(){var b=this,c=$('<div id="list-toolbar"><button id="list-new">Create [shift+return]</button><button id="list-delete">Delete [del]</button><button id="list-edit">Edit [space]</button><input type="text" id="search-list" /><div id="list-search-cancel">&nbsp;</div></div>');b.element.find("div.header").append(c);c.find("#list-new").button({text:false,icons:{primary:"ui-icon-plusthick"}});c.find("#list-delete").button({text:false,icons:{primary:"ui-icon-trash"}});c.find("#list-edit").button({text:false,
icons:{primary:"ui-icon-pencil"}});c.find("#list-delete").bind("click",function(i){if(b.selectedList!==null){if(typeof b.deleteDialog==="undefined")b.deleteDialog=$.confirmationDialog("Delete List",function(){if(b.listForm!==null){b.listForm.bind("FormHidden",function(){b._DeleteList(1E3)});b._HideForm()}else b._DeleteList()},"Cancel","Do you really want to delete?");b.deleteDialog.dialog("open")}else $("#notice").text("Select the list which you want to delete").fadeIn().delay(5E3).fadeOut();$(i.target).blur();
return false});c.find("#list-new").bind("click",function(i){b.listlist.hide("slide",{direction:"left"},"slow",function(){if(b.listForm!=null){b.listForm.remove();b.listForm=null}b.listForm=$('<div class="ui-layout-content" id="list-form"></div>');b.wrapper.append(b.listForm);List.New({successCallback:function(e,f){b.emptyListImage.hide();b.listForm.append(e);b.listForm.show("slide",{direction:"left"},"slow",function(){b.listForm.find("#list_title").first().focus()});b._trigger("CloseList",0,{});b.listForm.find("#list-back-button").bind("click",
function(){b._HideForm()});b.listForm.find("#list_title").bind("keydown","esc",function(){b._HideForm()});b.listForm.bind("submit",function(j){j.preventDefault();j=$(this).find("form").serializeForm();f.list=j.list;List.Create({send:f,successCallback:function(m,s,u,p,E){b._ClearFormErrors(b.listForm);if(E===false){b._HideForm(s,m);b.toolbar.find("#search-list").trigger("ClearValue")}else b._HighlightFormErrors(b.listForm,E)}});return false});b.selectedList=null}})});$(i.target).blur();return false});
c.find("#search-list").bind("keyup",function(){b._Filter()});c.find("#list-search-cancel").bind("click",function(){c.find("#search-list").val("").trigger("keyup")});c.find("#search-list").bind("ClearValue",function(i){$(i.target).val("");b.listlist.find(".row").show()});c.find("#list-edit").bind("click",function(){b.listlist.hide("slide",{direction:"left"},"slow",function(){if(b.listForm!=null){b.listForm.remove();b.listForm=null}b.listForm=$('<div class="ui-layout-content" id="list-form"></div>');
b.wrapper.append(b.listForm);List.Edit({successCallback:function(i){b.listForm.append(i);b.listForm.show("slide",{direction:"left"},"slow",function(){b.listForm.find("#list_title").first().focus()});b.listForm.find("#list-back-button").bind("click",function(){b._HideForm();return false});b.listForm.find("#list_title").bind("keydown","esc",function(){b._HideForm();return false});b.listForm.bind("submit",function(e){e.preventDefault();e=$(this).find("form").serializeForm();List.Update({send:e,successCallback:function(f,
j,m,s,u){b._ClearFormErrors(b.listForm);u===false?b._HideForm(j,f):b._HighlightFormErrors(b.listForm,u)},lists:b.selectedList.data.list.id});return false})},lists:b.selectedList.data.list.id})})});return c},_GetListElement:function(b,c){var i=this,e=$($.mustache(c,b.list));e.attr("tabindex",0);e.data("data",b);e.addClass("row");$.browser.msie&&e.bind("click",function(){e.focus();return false});e.bind("keydown","down",function(f){f.preventDefault();$(f.target).nextAll("div:visible").first().focus();
return false});e.bind("keydown","up",function(f){f.preventDefault();$(f.target).prevAll("div:visible").first().focus();return false});e.bind("focus",function(f){f=$(f.target);i.selectedList={element:f,data:f.data("data")};i.listlist.find(".row").removeClass("selected-row");f.addClass("selected-row");i.listlist.find(".assigned-tags").hide();f.find(".assigned-tags").show();i._AdjustHeight()});e.bind("keydown dblclick","return",function(){i._trigger("OpenList",0,{selectedList:e.data("data")})});e.bind("keydown",
"right",function(){i._trigger("SelectListItem",0,{})});e.bind("keydown","shift+return",function(){i.toolbar.find("#list-new").effect("puff",{},300,function(){$(this).show();$(this).trigger("click")});return false});e.bind("keydown","del",function(){i.toolbar.find("#list-delete").effect("puff",{},300,function(){$(this).show()}).trigger("click")});e.bind("keydown","space",function(){i.toolbar.find("#list-edit").effect("puff",{},300,function(){$(this).show();$(this).trigger("click")});return false});
e.droppable(i._DroppableConfigListItems(e));e.find(".assigned-tag-delete").bind("click",function(f){var j=$(f.target).parent(".assigned-tag");f=j.attr("data-id");var m=e.data("data");m.list.tag_id=f;m.list.tag_action="remove";List.Update({send:m,successCallback:function(s,u){j.hide("slow",function(){j.remove();i._ReplaceList(e,u,s);i._Filter()})},lists:m.list.id})});e.find(".assigned-tags").hide();return e},_triggerResize:function(){this._trigger("ContentDimensionsChanged",0,{})},_AdjustHeight:function(){this.listlist.find(".row").each(function(){var b=
$(this),c=b.find(".list-tag");b=b.find(".list-name");c.height(b.height()+10+"px")})},_AddListToDOM:function(b,c){this.listlist=$('<div id="list-list"></div>');this.wrapper.append(this.listlist);for(var i=0;i<b.length;i++)this.listlist.append(this._GetListElement(b[i],c));this._AdjustHeight();this._triggerResize()},_SelectLastList:function(){this.selectedList?this.selectedList.element.effect("highlight",{},300,function(){$(this).show();$(this).focus()}):this.listlist.find(".row").first().effect("highlight",
{},300,function(){$(this).show();$(this).focus()})},_RegisterGlobalKeyboardShortcuts:function(){var b=this;$(document).bind("keydown","ctrl+l",function(){b._SelectLastList()});$(document).bind("keydown","ctrl+f",function(){b.toolbar.find("#search-list").focus()});$(document).bind("keydown","shift+f",function(){b.toolbar.find("#search-list").focus();return false})},_ShowListView:function(b,c){var i=this;i.listlist.show("slide",{direction:"left"},"slow",function(){if(b){var e=i._GetListElement(b,c);
i._IsNewList(b)?i.listlist.prepend(e):i.selectedList.element.replaceWith(e);i._AdjustHeight();i._ToggleEmptyListImage();i.selectedList={data:b,element:e}}i.selectedList&&i.selectedList.element.focus()})},_HideForm:function(b,c){var i=this;i.listForm.hide("slide",{direction:"left"},"slow",function(){i._ShowListView(b,c);i.listForm.trigger("FormHidden");i._ToggleEmptyListImage();i.selectedList?i.selectedList.element.focus():i.listlist.find(".row").first().focus();i.listForm.remove();i.listForm=null})},
_Filter:function(){this._FilterBySearchText();this._FilterByTags()},_FilterBySearchText:function(){var b=this.toolbar.find("#search-list").val();if(b==="")this.listlist.find(".row").show();else{this.listlist.find(".row:visible:not(:Contains('"+b+"'))").hide();this.listlist.find(".row:visible:Contains('"+b+"')").show()}this._AdjustHeight();this._triggerResize()},_FilterByTags:function(){var b=this;b.listlist.find(".row:visible").each(function(){var c=$(this),i=c.data("data"),e=0;if(b.selectedTags.length>
0){for(var f=0;f<i.list.tags.length;f++)for(var j=0;j<b.selectedTags.length;j++)b.selectedTags[j]===i.list.tags[f].id&&e++;e===b.selectedTags.length?c.show():c.hide()}})},_create:function(){var b=this;b.selectedList=null;b.wrapper=b.element.find("div#list-wrapper");b.toolbar=b._CreateToolbar();b.listForm=null;b.selectedTags=[];var c=new Date;c=Date.UTC(c.getFullYear(),c.getMonth(),c.getDay(),c.getUTCHours(),c.getUTCMinutes(),c.getUTCSeconds(),c.getUTCMilliseconds());b.emptyListImage=$('<img src="/images/empty/list.jpg?'+
c+'"/>');b.emptyListImage.css({position:"absolute",top:"45px",left:"15px"});b.emptyListImage.hide();b.toolbar.append(b.emptyListImage);List.Index({successCallback:function(i,e){b.wrapper.find(".row").remove();b._AddListToDOM(e,i);b._ToggleEmptyListImage()}});b._RegisterGlobalKeyboardShortcuts()},_ToggleEmptyListImage:function(){if(this.listlist.find(".row").length>0){this.emptyListImage.hide();this.listlist.find(".row").first().focus()}else this.emptyListImage.show()},options:{},SetupDroppable:function(b){var c=
this;c.listlist.find(".row").each(function(){var i=$(this);i.droppable("destroy");switch(b){case "listitem":i.droppable(c._DroppableConfigListItems(i));break;case "tag":i.droppable(c._DroppableConfigTags())}})},ReloadLists:function(){var b=this;List.Index({successCallback:function(c,i){b.wrapper.find(".row").remove();b._AddListToDOM(i,c);b.toolbar.find("#search-list").trigger("keyup");b._Filter();b._ToggleEmptyListImage()}})},SelectList:function(){this._SelectLastList()},Filter:function(b){this.selectedTags=
b;this._Filter()},destroy:function(){this.toolbar.remove();this.listForm.remove();this.wrapper.find(".row").remove()}})})();(function(b){b.fn.serializeForm=function(){var c=b(this).find('*[name*="]"]'),i={};b.each(c,function(e,f){var j=b(f),m=j.get(0).name.split("[")[0],s=j.get(0).name.split("[")[1];s=s.replace("]","");j=j.val();i[m]=i[m]||{};i[m][s]=j});return i}})(jQuery);
...
null);widget.tagMenu.data("target",null);e.data("data",j)},tags:b.tag.id})});widget.tagMenu.find(".delete-label").bind("click",function(){widget.tagMenu.hide("fast");widget.tagMenu.data("visible",false);var b=function(){widget.tagMenu.data("tagId",null);widget.tagMenu.data("tag",null);widget.tagMenu.data("target",null)},c=function(){var i=widget.tagMenu.data("tag"),e=widget.tagMenu.data("target");Tag.Destroy({successCallback:function(){e.hide("fast",function(){e.parent(".tag").remove();widget.tagMenu.data("tagId",
null);widget.tagMenu.data("tag",null);widget.tagMenu.data("target",null)})},tags:i.tag.id})};if(typeof widget.deleteDialog==="undefined")widget.deleteDialog=$.confirmationDialog("Delete Tag",c,"Cancel","Delete Tag and remove it from all lists?",b);widget.deleteDialog.dialog("open");return false})},_create:function(){widget=this;widget.toolbar=$('<div id="tag-toolbar"></div>');widget.addTagInput=$('<input type="text" value="" id="add-tag"/>');widget.addTagButton=$('<button id="tag-new">Create Tag</button>');
widget.tagList=$('<div class="tags"></div>');widget.element.append(widget.toolbar);widget.toolbar.append(widget.addTagInput);widget.toolbar.append(widget.addTagButton);widget.element.append(widget.tagList);widget.addTagButton.button({text:false,icons:{primary:"ui-icon-plusthick"}});widget.selectedTags=[];Tag.Index({successCallback:function(b,c){for(var i=0;i<c.length;i++)widget.tagList.append(widget._GetTag(c[i],b));widget.tagMenu&&widget._CreateToolbar()}});widget.addTagButton.bind("click",function(){if($.trim(widget.addTagInput.val())!==
""&&widget.tagList.find(".tag-name:HasExactValue('"+$.trim(widget.addTagInput.val())+"')").length===0){var b={};b.tag={name:widget.addTagInput.val(),color_class:"c1"};Tag.Create({send:b,successCallback:function(c,i){var e=widget._GetTag(i,c);widget.tagList.prepend(e);widget.addTagInput.val("");widget.addTagInput.trigger("keyup");widget.tagMenu&&widget._CreateToolbar()}});return false}});widget.addTagInput.bind("keyup","return",function(){widget.addTagButton.trigger("click")});widget.addTagInput.bind("keyup",
function(){var b=$(this).val();if(b==="")widget.tagList.find(".tag").show();else{widget.tagList.find(".tag:not(:Contains('"+b+"'))").hide();widget.tagList.find(".tag:Contains('"+b+"')").show()}widget.tagList.find(".tag-name:HasExactValue('"+$.trim(b)+"')").length>0?widget.addTagButton.button("option","disabled",true):widget.addTagButton.button("option","disabled",false)})},options:{},destroy:function(){widget.element.children().remove()}})})();
