...
w){b.wrapper.find(".row").remove();B(w,k);b.toolbar.find("#search-list").trigger("keyup")}})},SelectList:function(){L()},FilterByTags:function(k){b.selectedTags=k;E()},destroy:function(){b.toolbar.remove();b.listForm.remove();b.wrapper.find(".row").remove()}}}();$.widget("ui.ListView",h)})();
