module TagsHelper
  ...
  def self.tag_colors
    ...
    color[ :c22 ] = TagColor.new( { :class_name => 'c22', :color_name => 'crimson', :background_color => 'DC143C', :foreground_color => 'eeeeee' } )
    color[ :c23 ] = TagColor.new( { :class_name => 'c23', :color_name => 'deeppink', :background_color => 'FF1493', :foreground_color => '222222' } )
    color[ :c24 ] = TagColor.new( { :class_name => 'c24', :color_name => 'darkmagenta', :background_color => '8B008B', :foreground_color => 'eeeeee' } )
